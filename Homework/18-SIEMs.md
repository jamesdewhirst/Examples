...
2. Using the `eval` command, create a field called `ratio` that shows the ratio between the upload and download speeds.
   ...
   - ![](https://github.com/jamesdewhirst/Examples/blob/main/Homework/Images/wk18/18-1.png)
...
1. Upload the following file from the Nessus vulnerability scan.
   - [Nessus Scan Results](https://du.bootcampcontent.com/denver-coding-bootcamp/du-den-cyber-pt-12-2020-u-c/blob/master/CourseMaterials/2-Homework/18-SIEMs/Resources/nessus_logs.csv)
